...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("deberia retornar estado http 200 cuando los datos ingresados son invalidos")
    @WithMockUser
    void agendarEsenario2() throws Exception {
        ...
        var response = mvc.perform(post("/consultas")
                ...
                .content(agendarConsultajacksonTester.write(new DatosAgendarConsulta(  1l,1l,fecha, especialidad)).getJson())
